...
call <SID>X('TabLineFill',    '',       s:base01, '')
call <SID>X('TabLineSel',     s:base03, s:base00, '')
call <SID>X('Tag',            s:base15, '',       '')
call <SID>X('TermCursor',     s:base00, s:base09, '')
call <SID>X('TermCursorNC',   s:base03, s:base10, '')
...
call <SID>X('cssFontDescriptorFunction', s:base07, '',       '')
call <SID>X('cssFunction',               s:base15, '',       '')
...
call <SID>X('cssKeyFrameSelector',       s:base07, '',       '')
...
call <SID>X('cssValueInteger',           s:base07, '',       '')
call <SID>X('cssValueLength',            s:base07, '',       '')
call <SID>X('cssValueNumber',            s:base07, '',       '')
